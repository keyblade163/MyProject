...
public class PropertiesHelper {
    ...
    private static String relPropertiesFilePathDefault = "src/main/resources/configs/configs.properties";

    public static Properties loadAllFiles() {
        LinkedList<String> files = new LinkedList<>();
        // Add tất cả file Properties vào đây theo mẫu
        files.add("src/test/resources/configs/configs.properties");
        files.add("src/test/resources/configs/dataTest.properties");
