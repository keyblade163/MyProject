...
public class CaptureHelper extends ScreenRecorder {
    ...
    public static void startRecord(String methodName) {
        ...
        File file = new File(Helpers.getCurrentDir() + PropertiesHelper.getValue("RECORDVIDEO_PATH"));
    ...
    public static void captureScreenshot(String screenshotName) {
        try {
            ...
            File theDir = new File(Helpers.getCurrentDir() + PropertiesHelper.getValue("SCREENSHOT_PATH"));
            if (!theDir.exists()) {
                theDir.mkdirs();
            }
            // Chổ này đặt tên thì truyền biến "screenName" gán cho tên File chụp màn hình
            FileHandler.copy(source, new File(Helpers.getCurrentDir() + PropertiesHelper.getValue("SCREENSHOT_PATH") + File.separator + screenshotName + "_" + dateFormat.format(new Date()) + ".png"));
